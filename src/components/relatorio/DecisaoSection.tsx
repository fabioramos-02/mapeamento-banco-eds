  ...
  return (
    <DashboardSection title="1. A decisão">
      <StoryCard
        ...
        caption={`Dos ${total} conjuntos de dados que existem hoje ${bancoFrase}, a maior parte pode ser descartada ou recriada do zero ${destinoFrase} — não copiada.`}
