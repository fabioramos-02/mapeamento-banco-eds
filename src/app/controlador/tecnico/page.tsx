...
export default function ControladorTecnicoPage() {
      ...
      <main className="max-w-5xl mx-auto px-6 py-8 flex flex-col gap-8">
        <section>
          ...
          <p className="text-sm mb-4" style={{ color: "var(--ds-color-text-secondary)" }}>
            ...
            auto-derivado do prefixo da tabela. Clique para expandir cada domínio.
          </p>
        ...
        <section>
          <div className="flex items-center justify-between mb-2 gap-4 flex-wrap">
            ...
            <a href="/consultas-controlador.sql" download className="ds-button ds-button--outline ds-button--sm">
              Baixar consultas-controlador.sql
            </a>
          </div>
          <p className="text-sm mb-4" style={{ color: "var(--ds-color-text-secondary)" }}>
