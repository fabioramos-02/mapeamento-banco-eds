...
export const metadata = { title: "Resumo executivo — Mapeamento do Banco Admin (EDS)" };
...
export default function AdminHome() {
  ...
  return (
    <>
      <GovHeader atual="/admin" dominio="admin" />
      <main className="max-w-5xl mx-auto px-6 py-8 grid gap-8">
        ...
        <DecisaoTabelaSection tabelas={inv.tabelas} hrefInventario="/admin/inventario" />
